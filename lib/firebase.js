...
export const storage = getStorage(app);import { initializeApp, getApps } from "firebase/app";
import { getAuth } from "firebase/auth";
import { getFirestore } from "firebase/firestore";
import { getStorage } from "firebase/storage";
...
const firebaseConfig = {
  ...
  storageBucket: "queenkarma-youmuseme.appspot.com",
  messagingSenderId: "426597182392",
  appId: "1:426597182392:web:be85f400787e9377484346"
};

// This ensures we don't crash the app by double-initializing
const app = getApps().length === 0 ? initializeApp(firebaseConfig) : getApps()[0];

// Export the "Internals" so the rest of the app can use them
...
// THE CORE IDENTITY OF QUEENKARMA-YOUMUSE-ME
const firebaseConfig = {
  apiKey: "AIzaSyAO0meH-eag2MERG62J4dHzEe1rDQGOK0Q",
  authDomain: "queenkarma-youmuseme.firebaseapp.com",
  projectId: "queenkarma-youmuseme",
  storageBucket: "queenkarma-youmuseme.appspot.com",
  messagingSenderId: "426597182392",
...
// Exporting the three pillars of your entity
export const auth = getAuth(app);    // Identity
export const db = getFirestore(app);   // Neural Brain (Lyrics/Pitch)
export const storage = getStorage(app); // 8TB Vault (Vocals)
export { app };
